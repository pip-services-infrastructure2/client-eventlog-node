...
import { EventLogCommandableHttpClientV1 } from '../version1/EventLogCommandableHttpClientV1';
...
export class EventLogClientFactory extends Factory {
	...
	public static HttpClientV1Descriptor = new Descriptor('service-eventlog', 'client', 'commandable-http', 'default', '1.0');
	...
	constructor() {
		...
		this.registerAsType(EventLogClientFactory.HttpClientV1Descriptor, EventLogCommandableHttpClientV1);
	}
